...
public class CompanyResourceIT {
    ...
    private static final String DEFAULT_BUSINESS_AREAS = "AAAAAAAAAA";
    private static final String UPDATED_BUSINESS_AREAS = "BBBBBBBBBB";
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company()
            .name(DEFAULT_NAME)
            .businessAreas(DEFAULT_BUSINESS_AREAS)
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company()
            .name(UPDATED_NAME)
            .businessAreas(UPDATED_BUSINESS_AREAS)
    ...
    public void createCompany() throws Exception {
        ...
        assertThat(testCompany.getBusinessAreas()).isEqualTo(DEFAULT_BUSINESS_AREAS);
    ...
    public void getAllCompanies() throws Exception {
        ...
        restCompanyMockMvc.perform(get("/api/companies?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].businessAreas").value(hasItem(DEFAULT_BUSINESS_AREAS)))
    ...
    public void getCompany() throws Exception {
        ...
        restCompanyMockMvc.perform(get("/api/companies/{id}", company.getId()))
            ...
            .andExpect(jsonPath("$.businessAreas").value(DEFAULT_BUSINESS_AREAS))
    ...
    public void updateCompany() throws Exception {
        ...
        assertThat(testCompany.getBusinessAreas()).isEqualTo(UPDATED_BUSINESS_AREAS);
